...
public class EvmsWebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/login", "/css/**", "/images/**").permitAll()
		    .and()
		    .formLogin().loginPage("/login").loginProcessingUrl("/doLogin").successForwardUrl("/postLogin").failureUrl("/loginFailed").permitAll()
		    .and()
		    ...
		    .and()
		    .authorizeRequests().antMatchers("/home", "/vaccine_type/*", "/report/*").hasAnyRole("ADMIN", "USER").anyRequest().authenticated();
   }
